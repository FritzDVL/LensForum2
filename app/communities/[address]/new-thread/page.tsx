  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (result.success && result.community) {
        ...
        const cats = await getCategories(result.community.group.address);
        const tgs = await getTags(result.community.group.address);
        setCategories(cats);
        setTags(tgs);
      }
    }
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-3">
            <ThreadCreateForm community={community} categories={categories} tags={tags} />
          </div>
          {/* Sidebar */}
